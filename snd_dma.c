/*
	...
	$Id: snd_dma.c,v 1.46 2006/10/22 09:46:49 sezero Exp $
*/
...
static	cvar_t	sfx_mutedvol = {"sfx_mutedvol", "0", true};
static	cvar_t	bgm_mutedvol = {"bgm_mutedvol", "0", true};
...
static	cvar_t	_snd_mixahead = {"_snd_mixahead", "0.1", false};
...
static void S_ToggleMute(void)
{
	if (sfx_mutedvol.value || bgm_mutedvol.value)
	{
		...
		if (volume.value || bgmvolume.value)
			Con_Printf ("Unmuted\n");
	}
	else
	{
		Cvar_SetValue("sfx_mutedvol", volume.value);
...
{
	if (volume.value >= 0.1)
		Cvar_SetValue("volume",volume.value - 0.1);
...
/*
 * $Log: snd_dma.c,v $
 * Revision 1.46  2006/10/22 09:46:49  sezero
 * various coding style clean-ups, part 8.
 *
 * Revision 1.45  2006/10/21 18:21:28  sezero
 ...
 *
 * Revision 1.38  2006/08/07 08:05:59  sezero
 ...
 * using cvars.
 *
 * Revision 1.37  2006/07/16 22:30:42  sezero
 * added mute, volumeup and volumedown console commands.
 * patch from Steven.
 *
 * Revision 1.36  2006/06/15 09:20:36  sezero
 ...
 * includes cleanup
 *
 * Revision 1.33  2006/03/24 15:05:39  sezero
 ...
 *
 * Revision 1.21  2005/06/06 10:17:05  sezero
 * put some notes on decision behavior for -sndspeed argument.
 *
 * Revision 1.20  2005/05/20 15:26:33  sezero
 ...
 *
 * Revision 1.19  2005/05/19 10:58:01  sezero
 * synced h2 and hw versions of snd_dma.c (use the new H2W define)
 *
 * Revision 1.18  2005/04/30 08:39:08  sezero
 ...
 *
 * Revision 1.13  2005/02/11 23:47:02  sezero
