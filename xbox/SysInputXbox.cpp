...
public:
	...
	bool UpdateGamepad(sXBGamepadInfo *pGamepadInfo);
	bool GetButtons(sXBGamepadInfo *pGamepadInfo);
private:
...
bool cSysInputXbox::UpdateGamepad(sXBGamepadInfo *pGamepadInfo)
{
...
bool cSysInputXbox::GetButtons(sXBGamepadInfo *pGamepadInfo)
{
