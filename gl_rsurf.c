...
void R_BlendLightmaps (void)
{
	...
	for (i=0 ; i<MAX_LIGHTMAPS ; i++)
	{
		...
		if (lightmap_modified[i])
		{
			...
			//glTexImage2D (GL_TEXTURE_2D, 0, lightmap_bytes, BLOCK_WIDTH, theRect->h, 0,gl_lightmap_format, GL_UNSIGNED_BYTE, lightmaps+(i*BLOCK_HEIGHT+theRect->t)*BLOCK_WIDTH*lightmap_bytes);
